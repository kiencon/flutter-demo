    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Todo` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `quantity` INTEGER NOT NULL, `name` TEXT NOT NULL)');
...
class _$TodoDAO extends TodoDAO {
  ...
  @override
  Future<void> deletePerson(Todo todo) async {
